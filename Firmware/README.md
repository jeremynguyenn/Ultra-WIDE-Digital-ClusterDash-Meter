...
- The original code for this project (e.g., custom `.c/.h` files in `Firmware/src`, etc.) is licensed under the `MIT License.`
- However, the following third-party contributions are subject to the terms of each company (i.e., not subject to the MIT License):
- Renesas FIT / Generated Code (e.g., `smc_gen`)
- Licensed under a no-warranty license intended for use on Renesas products. Please retain the copyright notice and disclaimer without modification.
- SEGGER emWin (GUI library)
- This repository does not redistribute this code. Please generate code from the Smart Configurator and add `r_emwin_rx` to your project.
- emWin has a non-redistribution clause and cannot be distributed to third parties without explicit permission from SEGGER.
### License Scope
- **MIT**: All original code
- **Renesas License**: FIT/generated code
- **SEGGER License**: emWin (redistribution not permitted)

For details, see `THIRD_PARTY_NOTICES.md`.
...
![image](https://github.com/user-attachments/assets/50a501ed-c50e-4862-8025-8d1785