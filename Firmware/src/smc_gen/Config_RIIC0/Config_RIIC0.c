...
void R_Config_RIIC0_Create(void)
{
    ...
    RIIC0.ICBRL.BYTE = _FB_IIC0_SCL_LOW_LEVEL_PERIOD;
    RIIC0.ICBRH.BYTE = _FC_IIC0_SCL_HIGH_LEVEL_PERIOD;
    ...
    IPR(RIIC0, RXI0) = _06_IIC_PRIORITY_LEVEL6;
    IPR(RIIC0, TXI0) = _06_IIC_PRIORITY_LEVEL6;
